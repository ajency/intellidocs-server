Ext.define('DMTApp.controller.DmtSettingsController', {
    ...
    //delete all the files and folder from device
					                                    	 ...
					                                    	 fileSystemRoot.getDirectory("intellidocs",
					                                                 ...
					                                                 function(dir){
					                                                	 ...
					                                                	 if(navigator.onLine)
					                                                     {
					                                                		...
					                                                		IntelliDocs.write_json(true,IntelliDocs.dmtGetUsernameFromCache());
	...
	dmtChangePasswordFormButtonTap:function(button)
	{
		...
		if(errors.isValid())
		{
			if(field_values.dmt_new_re_password == field_values.dmt_new_password)
			{
				...
				url: 'http://www.intellidocs.net/wp-content/plugins/aj-file-manager-system/includes/ajax_user_retrieve_password.php',
